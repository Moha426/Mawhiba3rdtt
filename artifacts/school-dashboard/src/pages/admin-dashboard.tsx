...
import { LogOut, BookOpen, Layers, CalendarRange, Users, Shield, SlidersHorizontal, AlertCircle, Clock, Trophy, Download, Upload, CalendarDays, Settings2 } from "lucide-react";
...
import { useGetDashboardStats, useListStudents, useListQuizzes } from "@workspace/api-client-react";
    ...
    >
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-5 border-b border-border/50">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">إدارة المهام والمواد والجدول والطلاب</p>
        </div>
